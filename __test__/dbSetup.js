...
async function setUpGroupScheduleDB() {
  await GroupSchedule.bulkCreate([
    ...
    {
      id: 22, groupId: 1, title: 'test-title', content: 'test-content1', startDate: '2021-12-15', endDate: '2022-05-20', repeat: 1, dayMonth: '15', month: '12', dayWeek: '*', confirmed: 0, possible: '["user1"]', impossible: '["user3"]',
    },
  ]);
}
