...
const {
  db, mockUser,tearDownUserDB, setUpUserDB, syncDB, tearDownPersonalScheduleDB, setUpPersonalScheduleDB, dropDB,
} = require('../dbSetup');
  ...
  describe('Test GET /api/user/:user_id/calendar', () => {
    it('Successfully get an April Schedule ', async () => {
      ...
      const expectedSchedule = {
        ...
        "recurrenceSchedule": [
          {
            "byweekday": "", "content": "test-content11", "freq": "DAILY", "id": 11, "interval": 1, "recurrence": 1,
            "recurrenceDateList": [
          ...
          {
            "byweekday": "", "content": "test-content13", "freq": "WEEKLY", "id": 13, "interval": 1, "recurrence": 1,
            "recurrenceDateList": [
              { "endDateTime": "2023-04-05T13:00:00.000Z", "startDateTime": "2023-04-05T12:00:00.000Z" },
          ...
          {
            "byweekday": "MO,TU", "content": "test-content15", "freq": "DAILY", "id": 15, "interval": 1, "recurrence": 1,
            "recurrenceDateList": [
              { "endDateTime": "2023-04-03T13:00:00.000Z", "startDateTime": "2023-04-03T12:00:00.000Z" },
              { "endDateTime": "2023-04-04T13:00:00.000Z", "startDateTime": "2023-04-04T12:00:00.000Z" },
          ...
          {
            "byweekday": "", "content": "test-content19", "freq": "YEARLY", "id": 19, "interval": 1, "recurrence": 1,
            "recurrenceDateList": [
          ...
          {
            "byweekday": "", "content": "test-content21", "freq": "MONTHLY", "id": 21, "interval": 1, "recurrence": 1,
            "recurrenceDateList": [
