  ...
  describe('Test GET /api/group', () => {
    it('Successfully get a list of group', async () => {
      ...
      const expectedGroups = {
        groupList: [{
          groupId: 1, leader: 1, name: 'test-group1', member: 5, inviteCode: 'inviteCode01', inviteExp: '2099-01-01T00:00:00.000Z', UserGroup: { groupId: 1, sharePersonalEvent: 1, userId: 1 },
        }, {
          groupId: 2, leader: 2, name: 'test-group2', member: 6, inviteCode: 'expiredCode02', inviteExp: '2000-01-01T00:00:00.000Z', UserGroup: { groupId: 2, sharePersonalEvent: 1, userId: 1 },
        }],
      };
