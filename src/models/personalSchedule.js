...
var PersonalSchedule = /** @class */ (function (_super) {
    ...
    PersonalSchedule.initiate = function (sequelize) {
    ...
    PersonalSchedule.getSchedule = function (userID, start, end) {
...
exports.default = PersonalSchedule;
