...
function userWithdrawal(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var error, userId, user, leader, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    error = (0, validators_1.validateUserIdSchema)(req.params).error;
                    if (error)
                ...
                case 3:
                    leader = _a.sent();
                    if (!!leader) return [3 /*break*/, 6];
                    return [4 /*yield*/, personalSchedule_1.default.destroy({ where: { userId: userId } })];
                case 4:
                    _a.sent();
                ...
                case 5:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 6: return [2 /*return*/, next(new errors_1.userErrors.UserIsLeaderError())];
                case 7: return [2 /*return*/, res.status(204).json({ message: 'Successfully deleted' })];
                case 8:
                    err_1 = _a.sent();
